...
//                     <div className=" mt-10 lg:mt-24 xl:mt-32">
//                         <div className="text-4xl lg:text-5xl mb-5 xl:mb-5 text-white">
//                             Terms & Conditions
//                         </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
//                             <p>These terms of use (&ldquo;Terms and Conditions&rdquo;) mandate the terms on which the users (&ldquo;You&rdquo; or &ldquo;Your&rdquo; or &ldquo;User&rdquo;) can access and register on the website hypecard.in including its mobile application 'WithSpark/Spark&rsquo; operated and managed by Hypecard Private Limited (&ldquo;Company&rdquo; or &ldquo;We&rdquo; or &ldquo;Us&rdquo;) a company duly incorporated under the laws of India, having corporate identification number U72900RJ2021PTC077227, collectively referred to as, the &ldquo;Platform&rdquo;. IF YOU DO NOT AGREE TO THESE TERMS AND CONDITIONS AND THE TERMS AND CONDITIONS OF SAFE GOLD (AS AVAILABLE AT https://www.safegold.com/terms-and-conditions), YOU MAY NOT USE THE PLATFORM AND SHOULD NOT PROCEED TO CREATE ANY ACCOUNTS OR ACQUIRE ANY SUBSCRIPTIONS TO THE PLATFORM. BY USING THE PLATFORM, YOU ARE AGREEING TO BE BOUND BY THESE TERMS AND CONDITIONS, INCLUDING ALL AMENDMENTS MADE HERETO FROM TIME TO TIME.  This is an electronic record in terms of the Information Technology Act, 2022 and the rules made thereunder, and does not require any physical or digital signatures. This is being published in accordance with Rule 3(1) of the Information Technology (Intermediaries Guidelines) Rules, 2011.  The Platform is an online portal that facilitates the Users to purchase/sale/transfer gold in digital form from a brand named &lsquo;Safe Gold&rsquo; (&ldquo;Gold&rdquo;) operated and managed by Digital Gold India Private Limited (&ldquo;Safe Gold&rdquo;), a company incorporated under the laws of India with corporate identification number U74999MH2017PTC293205, and Safe Gold provides for purchase and sale of Gold, and providing services of safe keeping, vaulting, delivery and fulfilment of gold and related services (&ldquo;Services&rdquo;).  YOU EXPRESSLY UNDERSTAND AND AGREE THAT COMPANY IS ONLY A DISTRIBUTOR THAT FACILITATES USERS TO BUY GOLD FROM SAFE GOLD. YOU UNDERSTAND THAT BY&#8239;REGISTERING TO THE PLATFORM AND/OR ACCESSING SERVICES DIRECTLY OR INDIRECTLY FROM THE PLATFORM, YOU ONLY RECEIVE THE ABILITY TO&#8239;USE THE PLATFORM FOR PURCHASE OF GOLD FROM SAFE GOLD OR SUCH OTHER PRODUCTS OFFERED BY US FROM TIME TO TIME. WE SHALL NOT INCUR ANY LIABILITY IN RELATION TO ANY DISPUTE RELATING THAT ARISES IN RELATION TO PURCHASE OF GOLD OR SERVICES OFFERED BY SAFE GOLD. YOU EXPRESSLY AGREE THAT WE ARE NOT RESPONSIBLE FOR CUSTODY, QUANTITY AND QUALITY OF PHYSICAL GOLD THAT YOU PURCHASE THROUGH THE PLATFORM AND HENCE WE SHALL NOT BE LIABLE IN CASE OF ANY DISPUTE THAT ARISES IN RELATION TO CUSTODY OF PHYSICAL GOLD WITH THE CUSTODIAN AND TRUSTEESHIP WITH THE TRUSTEE ADMINISTRATOR. You understand that the Gold is being offered for purchase by Safe Gold, and the User can also sell the Gold through Safe Gold. As per the terms and conditions of Safe Gold (available at https://www.safegold.com/terms-and-conditions), the Gold purchased by You will be accounted in a customer account maintained by Safe Gold and the corresponding quantity of gold in physical form will be storied with Brinks India Private Limited (&ldquo;Custodian&rdquo;). In order to safeguard Your interest, Safe Gold has also appointed a trustee (&ldquo;Trustee Administrator&rdquo;), and You agree to the appointment of such Trustee Administrator and the Custodian, and also accede to the terms for such arrangement with the Trustee Administrator (being the Trustee Administrator agreement). The Trustee Administrator shall be responsible for monitoring the physical gold held on Your behalf with the Custodian.  Please read these Terms and Conditions and privacy policy (available at https://www.hypecard.in/privacy-policy) carefully before registering on the Platform or accessing any material and/or information through the Platform. The Company retains an unconditional right to modify or amend this Terms and Conditions without any requirement to notify You of the same. You can determine when this Terms and Conditions was last modified by referring to the &lsquo;Last Updated&rsquo; legend above. It shall be Your responsibility to check this Terms and Conditions periodically for changes. Your continued use of the Platform shall indicate an acceptance of the amended Terms and Conditions, and shall signify Your consent to the changes to the Terms and Conditions and the intention to be legally bound by the amended Terms and Conditions. Before using our Services and before buying the Gold, Users are also recommended to read the terms of services and privacy policy of Digital Gold India Private Limited which can be accessed at https://www.safegold.com/terms-and-conditions. In case of any conflict between this Terms and the terms of Safe Gold, the terms of Safe Gold in relation to the purchase and/or sale of Gold shall prevail. It is also clarified that these Terms and Conditions and the terms and conditions of Safe Gold apply to You once you avail of the Services and purchase Gold.  By using the Services, you acknowledge that Company is not responsible for the quality of physical gold being offered and sold by Digital Gold India Private Limited and that any disputes in relation to the quality of physical gold shall be raised directly by You to Digital Gold India Private Limited.</p>
//                         </div>

//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white">1. ELIGIBILITY </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">By using the
//                             Services, you represent and warrant that you are above the 18 years of age and qualified to enter into a legally binding contract, enforceable under Indian law, including the Indian Contract Act, 1872. If you are not eligible to enter into any contract, then please discontinue use of the Platform and leave now. If you are the parent or guardian of a child under 18 years of age, by registering/by creating an account or profile on the Platform, you provide your consent to your child’s registration and you agree to be bound by these Terms and Conditions in respect of their use of our Platform. We will at all times assume (and by using this Platform you warrant that) you have the legal ability to purchase and sale Gold and otherwise use this Platform, and capable of being bound by these Terms and Conditions. Further, by using the Platform, You confirm that you are not registered under any applicable  Goods and Services Tax Act, 2017 and that if, in the course of your relationship with our Platform and/or Safe Gold, you become registered under the applicable Goods and Services Tax Act, 2017, you shall inform Safe Gold of your change in status immediately, and no later than 24 hours of such change, and provide any relevant information and documents, as may be requested by Safe Gold. The Company shall not be liable for any actions that may be undertaken by Safe Gold pursuant to change of Your status on registration under the applicable Goods and Services Tax Act, 2017. If necessary, You shall seek independent tax advice, and these Terms and Conditions do not constitute any tax advice to You.
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white">2. REGISTRATION
//                         </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
...
//                             </ol>
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white">3. PLATFORM SERVICES </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
//                             <ol className="list-decimal">
//                                 <li>
...
//                                 </li>
//                                 <li>
//                                     You wish to get Your Customer Gold delivered to Your doorstep. The KYC verification shall be undertaken based on the PAN Card issued to You. You shall upload a clear picture of your PAN Card except in cases where e-PAN is provided by You. We shall verify Your details from the database of the issuing authority, including through Digilocker. If You do not have a PAN Card, you may submit Form 60 to Us.
//                                 </li>
//                                 <li>
//                                     It is hereby clarified that any Services offered (purchase, sale or transfer of Gold on Safe Gold’s platform) are governed under specific terms and conditions of Safe Gold, operated and managed by Gold India Private Limited which can be accessed at https://www.safegold.com/terms-and-conditions.
//                                 </li>
//                                 <li>
...
//                                 </li>
//                                 <li>
//                                     copy, republish, post, display, translate, transmit, reproduce or distribute any content on the Platform through any medium without obtaining the necessary authorization from the Company in writing;
//                                 </li>
//                                 <li>
...
//                                 </li>
//                                 <li>
//                                     probe, scan or test the vulnerability of the Platform or any network connected to the Platform, nor breach the security or authentication measures on the Platform or any network connected to the Platform.
...
//                             </ol>
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white">
//                             6. DELIVERY OF GOLD
//                         </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
...
//                             <br /><br />
//                             <ol className="list-decimal">
//                                 <li>  You are required to take delivery of Your Customer Gold within such maximum period as shall be specified for this purpose by Safe Gold from time to time on the Platform (“Maximum Storage Period”).
//                                 </li>
//                                 <li>  In the event that no valid address has been provided by You during the Maximum Storage Period, then Platform and/ Safe Gold shall for a period 1 (one) year commencing from the date of expiry of Maximum Storage Period (such period being the “Grace Period”) attempt at least once to contact You using the contact information provided by You to obtain either (i) an address to which You would require the gold in question to be delivered or (ii) Your bank account details into which sale proceeds of the Customer Gold shall be deposited. In the event that Platform and/or Safe Gold has not been able to contact You during the applicable Grace Period using the contact information provided by You or where You shall during the Grace Period either fail to take delivery of the physical gold in question for any reason whosoever (including where You shall not have provided any address to take delivery of such physical gold); or provide the details for a valid bank account into which the proceeds of any sale of such Customer Gold is to be deposited;  then upon expiry of the applicable Grace Period for the Customer Gold in question, Safe Gold shall be entitled to purchase such Customer Gold with the purchase price being the applicable prevailing price displayed on the Platform for purchase of Gold from Customers.
//                                 </li>
//                                 <li>  The purchase proceeds realized from such sale of Gold on Safe Gold’s platform (“Final Sale Proceeds”) after deducting any amounts payable to Safe Gold as storage charges after the free storage period, shall be deposited into a bank account operated by the Trustee Administrator who shall be the sole signatory to such bank account. In the event that You shall during a period of 3 (three) years commencing from the date of expiry of the applicable Grace Period (such period being the “Final Claim Period”) notify either the Platform, Safe Gold and/or the Trustee Administrator that You are claiming the applicable Final Sale Proceeds, the Trustee Administrator shall issue suitable instructions to transfer the Final Sale Proceeds to such bank account as You shall notify for this purpose. Please note that to claim the Final Sale Proceeds You will be required to provide details of a valid bank account and that the Final Sale Proceeds will not be transferred in the absence of such details. At no time will the Final Sale Proceeds be paid to You in cash. In the event that You shall not claim Your Final Sale Proceeds within the Final Claim Period, then the Final Sale Proceeds shall be transferred to the Prime Minister’s Relief Fund or such other fund as You may designate for this purpose at any time prior to the expiry of the Grace Period.
//                                 </li>
//                             </ol>
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white">7. RETURN, REFUND AND CANCELLATION POLICY </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
//                             <ol className="list-decimal">
//                                 <li>  On use of any coupon or discounts, as made available by us on the Platform or any other website or platform of any authorised third party, for purchase of Gold, the same shall be verified and adjusted, as may be necessary, within 7 (seven) days of use of such coupon or discount.
//                                 </li>
//                                 <li>  Upon confirmation of the payment, You shall be permitted to withdraw the monies after 24 (twenty-four) hours of investment, and there is no minimum lock-in period.
//                                 </li>
//                                 <li>  Once the payment has been confirmed, the same shall be binding on You and cannot be cancelled.
//                                 </li>
//                                 <li>  You can opt out of auto investing on the Platform by undertaking the following actions:
//                                 </li>
//                                 <li>  Tap on 'Locker' in the bottom right corner on the mobile application.
//                                 </li>
//                                 <li>  Go to 'Settings' by tapping on the icon on the top right corner on the mobile application.
//                                 </li>
//                                 <li>  Scroll down and find ‘AutoPay’ under transactions and withdrawals on the mobile application.
//                                 </li>
//                                 <li>  Disable AutoPay by tapping on the toggle on the mobile application.
//                                 </li>
//                                 <li>  You can also pause their roundup detection and savings for a defined period of time. You can find the option of pausing Your saving for 10 (ten) days to 1 (one) month in the settings of the mobile application.
//                                 </li>
//                             </ol>
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white"> 8. YOUR OBLIGATIONS AND RESPONSIBILITIES </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
//                             <ol className="list-decimal">
//                                 <li> While accessing our Platform, You shall comply with these Terms and Conditions and the special warnings or instructions for access or use posted on the Platform from time to time.
//                                 </li>
//                                 <li> You shall not make any change or alteration to the Platform or any Content or Services that may appear on this Platform or on Safe Gold and shall not impair in any way the integrity or operation of the Platform.
//                                 </li>
//                                 <li> You shall always act in accordance with extant laws, customs and in good faith.
//                                 </li>
//                                 <li> You further represent and warrant that:
//                                 </li>
//                                 <li> Payment for purchase of Services is made from Your bank account (primary holder’s bank account in case of Investment Account held jointly), and the same is from legitimate sources and remitted through approved banking channels;
//                                 </li>
//                                 <li> Before making the investment purchase, You shall seek independent financial planning, legal, accounting, tax or other professional advice, if required;
//                                 </li>
//                                 <li> You have read the offer documents of Safe Gold (including its terms and conditions accessed at https://www.safegold.com/terms-and-conditions) and its schemes and have made an informed independent investment decision before investing; and
//                                 </li>
//                                 <li> You will not sell, trade, or otherwise transfer Your registered account to another party or impersonating any other person for the purposing of creating an account with the Platform.
//                                 </li>
//                                 <li> You agree and acknowledge and confirm that You solely, and to the exclusion of the Company, are liable for all liabilities that may arise on acts of omission or commission attributable to You, including but not limited to acts such as making inputs pertaining to UPI details, phone number or email addresses, bank account details, addresses, etc.
//                                 </li>
//                                 <li> Without limiting the generality of any other provision of these Terms and Conditions, if you commit any default in any of the obligations set forth in these Terms and Conditions, you shall be liable for all the losses and damages that this may cause to the Platform, Company, our partners or licensors.
//                                 </li>
//                             </ol>
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white">9. INTELLECTUAL PROPERTY RIGHTS </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
//                             <ol className="list-decimal">
...
//                             </ol>
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white">10. LIMITATION OF LIABILITY

//                         </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
//                             <ol className="list-decimal">
//                                 <li>  The Content on this Platform is for your general information and use only and does not amount to any investment advice.
//                                 </li>
...
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white"> 12. LIMITATION IN PLATFORM SERVICES</div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
...
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white"> 13. THIRD PARTY LINKS</div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
...
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white"> 14. FORCE MAJEURE </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
...
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white"> 15. SUSPENSION AND TERMINATION </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
...
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white"> 16. GOVERNING LAWS</div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
...
//                             All Grievances related to the use of Platform shall be addressed to Mr. Yogesh Bhati. Please write us on grievance-officer@hypecard.in. The Grievance Officer will get back to the User within 48 hours of the receipt of any complaint from You.
...
//                         </div>
//                         <div className="text-2xl lg:text-3xl mb-5 xl:mb-5 text-white">20. GENERAL PROVISIONS</div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5 ml-8">
//                             <ol className="list-decimal">
//                                 <li>  Notice: All notices from the Company will be served by email to Your registered email address or by general notification on the Platform. Any notice provided to the Company pursuant to the Terms and Conditions should be sent to info@hypecard.in.
//                                 </li>
//                                 <li>  Assignment: You cannot assign or otherwise transfer the Terms and Conditions, or any rights granted hereunder to any third party. The Company’s rights under the Terms and Conditions are freely transferable by the Company to any third party without Your consent.
//                                 </li>
...
//                                 </li>
//                                 <li>  Waiver: Any failure by the Company to enforce or exercise any provision of the Terms and Conditions, or any related right, shall not constitute a waiver by the Company of that provision or right.
//                                 </li>
//                             </ol>
//                         </div>
//                         <div className="text-base lg:text-lg xl:text-xl mb-5">
//                             Hypecard Private Limited
//                             <br />
//                             Registered Office address: E-4A Laxmi Villa, New Colony, Panch Batti, M. I. Road, Jaipur 302001, India
//                             <br />
//                             Email: info@hypecard.in
//                         </div>
//                     </div>
//                 </div>
//             </section>
